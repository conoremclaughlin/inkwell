...
export function buildEntityExtractionPrompt(
  ...
  return {
    ...
    userPrompt: [
      ...
      '- Preserve distinctive item-property relationships in descriptions when useful, e.g. an app that uses mnemonics, a tool used for a task, a named dish with its ingredients, or a named document with its purpose.',
...
export function buildDurableFactExtractionPrompt(
  ...
  return {
    ...
    userPrompt: [
      ...
      '- Also extract precise answerable details from assistant responses when they may be asked about later: named recommendations, list-item mappings, durations, quantities, colors, URLs, ordinal entries, procedures, constraints, code/chords, or exact quoted values.',
...
export function buildSummaryExtractionPrompt(
  ...
  return {
    ...
    userPrompt: [
      ...
      '- keyPoints should capture the most important supporting points, including exact values, names, durations, URLs, or list-item mappings when those are likely future follow-up targets.',
...
export function buildBatchExtractionPrompt(
  ...
  return {
    ...
    userPrompt: [
      ...
      '- Entity descriptions should preserve distinctive item-property relationships when useful, e.g. an app that uses mnemonics, a tool used for a task, a named dish with its ingredients, or a named document with its purpose.',
      ...
      '- Durable facts should also preserve precise answerable details from assistant responses when they may be asked about later: named recommendations, list-item mappings, durations, quantities, colors, URLs, ordinal entries, procedures, constraints, code/chords, or exact quoted values.',
