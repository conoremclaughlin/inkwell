...
if [[ -n "${ENABLE_HEARTBEATS:-}" && -z "${ENABLE_HEARTBEAT_SERVICE:-}" ]]; then
  echo "  NOTE: ENABLE_HEARTBEATS is deprecated; use ENABLE_HEARTBEAT_SERVICE instead."
fi
if [[ -n "${ENABLE_HEARTBEATS:-}" && -n "${ENABLE_HEARTBEAT_SERVICE:-}" && "${ENABLE_HEARTBEATS}" != "${ENABLE_HEARTBEAT_SERVICE}" ]]; then
  echo "  NOTE: ENABLE_HEARTBEAT_SERVICE overrides ENABLE_HEARTBEATS when both are set."
fi
